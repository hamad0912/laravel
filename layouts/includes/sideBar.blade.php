    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
      ...
      <div class="offcanvas offcanvas-end" style="background-color: #e3f2fd; tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body" style="background-color: #e3f2fd;">
            <ul class="navbar-nav ">
              <li> <a href="#" class="btn btn-outline rounded-pill"> <i class="fa fa-user"></i> Users</a></li> 
               ...
               <li> <a href="#" class="btn btn-outline rounded-pill"> <i class="fa fa-file"></i> التقارير</a></li> 
               <li> <a href="#" class="btn btn-outline rounded-pill"> <i class="fa fa-money-bill"></i> العمليات</a></li> 
              ...
              <li> <a href="{{ route('categories.index')}}" class="btn btn-outline rounded-pill"> <i class="fa fa-barcode"></i> التصنيفات</a></li> 
